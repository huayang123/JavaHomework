...
<script type="text/javascript">
			$(function(){
				//弹出层插件调用
				new PopupLayer({
					trigger:".clickedElement", //触发点，规定点击什么触发div
					popupBlk:"#showDiv",       //规定弹出哪个div
					closeBtn:"#closeBtn",      //关闭触发点
					useOverlay:true
				});
				...
				$.post(
						...
						function(data){
							...
							for(var i=0;i<data.length;i++){
								...
								"<td>"+
									"<img src='${pageContext.request.contextPath }/"+data[i].product_image+"' width='70' height='60'>"+
								"</td>"+
								"<td><a target='_blank'>"+data[i].product_name+"</a></td>"+
